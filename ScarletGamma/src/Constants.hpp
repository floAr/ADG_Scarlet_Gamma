...
static const std::string STR_5 = std::string("5");
static const std::string STR_6 = std::string("6");
static const std::string STR_7 = std::string("7");
static const std::string STR_8 = std::string("8");
...
static const std::string STR_LIZARDFOLK_NAME = std::string("Echsenvolk");
static const std::string STR_SKELETON_NAME = std::string("Skelett");
...
static const std::string STR_LAYER4 = std::string("4: Gegenstände");
static const std::string STR_LAYER5 = std::string("5: Magisches");
static const std::string STR_LAYER6 = std::string("6: Freunde");
static const std::string STR_LAYER7 = std::string("7: Neutral");
static const std::string STR_LAYER8 = std::string("8: Feinde");
static const std::string STR_LAYER9 = std::string("9: Eigenes I");
static const std::string STR_LAYER10 = std::string("0: Eigenes II");
