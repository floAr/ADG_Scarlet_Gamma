...
Über ein internes Rechte System kann der Spielleiter definieren in welcher Weise die Objektdaten für Spieler sichtbar sind. So kann zum Beispiel einem Waldläufer eine Eigenschaft die Daten über eine Fährte enthält angezeigt werden, anderen Spielern bleibt diese Information jedoch verwehrt. So kann der Spielleiter gezielt Daten für einzelne Spieler freigeben, oder aber auch Objekte wie NPCs oder Items mit Notizen anreichern, die nur für ihn selbst sichtbar sind.\newline
